export class Popup {
    constructor() {
        ...
        this.cancelBtnEl = Button([], "Отмена", this.close.bind(this, false));
        this.okBtnEl = Button([], "ОК", this.close.bind(this, true));
    ...
    fireEvent(type, v = false) {
        switch (type) {
            case "close":
                this.onClose.forEach(f => f(v, this));
                break;
            case "ok":
