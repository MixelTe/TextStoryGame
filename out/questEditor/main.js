...
import { addQuest, Form, getQuest, getQuests, removeQuest, saveQuest } from "./functions.js";
...
function renderQuests() {
    ...
    for (let i = 0; i < quests.length; i++) {
        ...
        const button = Button([], "···", async () => {
            ...
            if (Editor_Options.DownloadQuestOption)
                menu.push({ text: "Сохранить", id: "download" });
